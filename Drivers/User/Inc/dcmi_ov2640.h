...
extern volatile uint8_t 	OV2640_FrameState;  	// DCMI状态标志，当数据帧传输完成时，会被 HAL_DCMI_FrameEventCallback() 中断回调函数置 1 
extern volatile uint8_t 	OV2640_FPS ;      	// 帧率
extern volatile uint8_t 	OV2640_BufferCount;  // 缓冲计数
...
#define OV2640_Width          800   // 图像长度 
#define OV2640_Height         600  // 图像宽度
